...
def test_add_new_pet_with_valid_data(name='Барыс', animal_type='немного тигр',
...
# положительный тест-кейс с корректно введенным запросом
def test_add_new_pet_with_valid_data_2(name='Барыс', animal_type='немного тигр',
                                     age='4', pet_photo='images/cat1.jpg'):
    """Проверяем что можно добавить питомца с корректными данными"""
...
# положительный тест-кейс с корректно введенным запросом
def test_add_new_pet_with_valid_data_3(name='Черчилль', animal_type='бульдог',
                                     age='3', pet_photo='images/buldog.jpeg'):
    """Проверяем что можно добавить питомца с корректными данными"""
...
def test_add_new_pet_with_invalid_data(name='Марыс', animal_type='мега тигр',
                                     age='сто', pet_photo='images/cat2.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Марыс", "мега тигр", "сто", "images/cat1.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
